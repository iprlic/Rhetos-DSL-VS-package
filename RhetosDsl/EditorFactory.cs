...
namespace Omega.RhetosDsl
{
    ...
    /// </summary>
    [Guid(GuidList.guidRhetosDslEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private RhetosDslPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(RhetosDslPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidRhetosDslEditorFactory;
            pgrfCDW = 0;

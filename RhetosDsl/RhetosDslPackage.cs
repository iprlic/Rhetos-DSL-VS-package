...
namespace Omega.RhetosDsl
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".rhe", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "RhetosDsl")]
    [ProvideKeyBindingTable(GuidList.guidRhetosDslEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidRhetosDslPkgString)]
    public sealed class RhetosDslPackage : Package
    {
        /// <summary>

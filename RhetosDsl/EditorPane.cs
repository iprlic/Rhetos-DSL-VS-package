...
namespace Omega.RhetosDsl
{
    ...
    //     - An empty rhe file in the same directory as NewFileItems.vsdir. In
    //       our case we chose Module.rhe. Note this file name appears in Editor.vsdir
    ...
    //          - "Module" - This is the base file name. New files will initially
    //             be named as Module1.rhe, Module2.rhe... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    Module.rhe|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - Module.rhe - our empty rhe file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".rhe";
        ...
        #region Fields
        private RhetosDslPackage myPackage;
        ...
        public EditorPane(RhetosDslPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the rhe document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(RhetosDslPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidRhetosDslCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidRhetosDslCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidRhetosDslEditorFactory;
            return VSConstants.S_OK;
        }
